...
- (void)awakeFromNib {
  ...
  _btmLine = [[UIView alloc] initWithFrame:CGRectMake(15, 91, self.frame.size.width-15, 1)];
  if (temp) {
    self.contentView.backgroundColor = [UIColor whiteColor];
    _btmLine.backgroundColor = [UIColor colorWithRed:245.0f/255.0f green:245.0f/255.0f blue:245.0f/155.0f alpha:1];
    self.themeTitleLabel.textColor = [UIColor blackColor];
  } else {
    ...
    self.themeTitleLabel.textColor = [UIColor lightGrayColor];
  }
